...
<head>
	...
	$(document).ready(function(){
		console.log( "customCompUpdate.ready()" );
		let imgHtml = '<img src="${ctxPath}/custom/${vo.customImgFileName}" width="80px"/>';
		$("#rt").html(imgHtml);
...
<div class="container" style="padding:30px" >
  <form name="updateForm" method="post" action="${ctxPath}/customComp/customCompUpdate" class="was-validated" enctype="multipart/form-data">
    ...
    <div class="form-group">
			...
			<input type="text" class="form-control" id="customNameShort" name="customNameShort" value="${vo.customNameShort}" maxlength=20 required />
    ...
    <div class="form-group" id="hpGroup">
			...
			<div class="input-group">
				...
				_<div><input type="text" id="hp2" name="hp2" value="${vo.hp2}" size=4 maxlength=4 class="form-control" /></div>
				_<div><input type="text" id="hp3" name="hp3" value="${vo.hp3}" size=4 maxlength=4 class="form-control" /></div>
	 			<div id="blank" class="is-invalid"></div>
...
--%>    
	<div class="form-group">
	  ...
	  <div id="rt"></div>
 	  <div class="input-group mb-3 input-group-lg">
			...
			<input type="hidden" id="photo" name="photo" value="${vo.customImgFileName}"/>
	  </div>
    </div>
    <div class="form-group text-center">
	    ...
	    <input type="button" class="btn btn-info" value="돌아가기" onclick="location.href='${ctxPath}/customComp/customCompMain';"/><br>
		</div>
  </form>
</div>
...
<script>
	...
	//이미지 미리보기
 	let rt_imageChange = function(input) {
		...
		reader.onload = function (e) {
			let imgHtml = '<img id="rt_image" class="m-10" style="width:100%;border-radius:15px;">';		
			$("#rt").html(imgHtml);
	...
	$(".custom-file-input").on("change", function() {
		...
		if ('' == fileName) {
	    	...
	    	<%--$("#photo").val(수정전 원본사진 유지)//위에서 설정해서 여기서는 편집안함--%>
